"""Evaluate original-VGGT predictions with the VGGT-Omega protocol."""
...
from vggt.evaluation import preprocess_sintel_depth, read_bonn_depth, write_csv
...
if __package__:
    ...
    from .infer_vggt import DEFAULT_DATASET_ROOTS, sequence_images, sequence_names, sequence_poses
